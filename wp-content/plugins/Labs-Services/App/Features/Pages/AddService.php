...
class AddService
{
    ...
    public static function init()
    {
        ...
        add_menu_page(
            __('Formulaire pour ajouter un service'), // Le titre qui s'affichera sur la page
            __('Service'), // le texte dans le menu
            ...
            'add-service', // Le slug du menu
            [self::class, 'render'], // La méthode qui va afficher la page
            'dashicons-analytics', // L'icon dans le menu
    ...
    public static function render()
    {
        ...
        //echo "Hello";
        $action = isset($_GET["action"]) ? $_GET["action"] : "index";
        call_user_func([ServiceController::class, $action]);
    }
